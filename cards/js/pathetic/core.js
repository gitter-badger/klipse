...
return cljs.core.map.call(null,cljs.core.first,cljs.core.take_while.call(null,(function (p1__74615_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__74615_SHARP_),cljs.core.second.call(null,p1__74615_SHARP_));
}),cljs.core.map.call(null,(function (p1__74616_SHARP_,p2__74617_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__74616_SHARP_,p2__74617_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__74619 = cljs.core.first.call(null,path_pieces);
switch (G__74619) {
case "":
...
var G__74622 = (((cljs.core.first.call(null,path_pieces) instanceof cljs.core.Keyword))?cljs.core.first.call(null,path_pieces).fqn:null);
switch (G__74622) {
case "root":
...
var G__74625 = cljs.core.last.call(null,path_pieces);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cwd","cwd",14056523),G__74625)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,"..",G__74625)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),G__74625)){
return path_pieces;
} else {
...
while(true){
var vec__74632 = remaining_path;
var seq__74633 = cljs.core.seq.call(null,vec__74632);
var first__74634 = cljs.core.first.call(null,seq__74633);
var seq__74633__$1 = cljs.core.next.call(null,seq__74633);
var curr = first__74634;
var remainder = seq__74633__$1;
var pred__74635 = cljs.core._EQ_;
var expr__74636 = curr;
if(cljs.core.truth_(pred__74635.call(null,null,expr__74636))){
return result;
} else {
if(cljs.core.truth_(pred__74635.call(null,"",expr__74636))){
var G__74638 = result;
var G__74639 = remainder;
result = G__74638;
remaining_path = G__74639;
continue;
} else {
if(cljs.core.truth_(pred__74635.call(null,".",expr__74636))){
var G__74640 = result;
var G__74641 = remainder;
result = G__74640;
remaining_path = G__74641;
continue;
} else {
if(cljs.core.truth_(pred__74635.call(null,"..",expr__74636))){
var G__74642 = pathetic.core.up_dir.call(null,result);
var G__74643 = remainder;
result = G__74642;
remaining_path = G__74643;
continue;
} else {
var G__74644 = cljs.core.conj.call(null,result,curr);
var G__74645 = remainder;
result = G__74644;
remaining_path = G__74645;
continue;
}
}
}
...
var pred__74649 = cljs.core._EQ_;
var expr__74650 = curr;
if(cljs.core.truth_(pred__74649.call(null,null,expr__74650))){
return suffix;
} else {
if(cljs.core.truth_(pred__74649.call(null,"",expr__74650))){
var G__74652 = suffix;
var G__74653 = cljs.core.rest.call(null,remainder);
suffix = G__74652;
remainder = G__74653;
continue;
} else {
if(cljs.core.truth_(pred__74649.call(null,".",expr__74650))){
var G__74654 = suffix;
var G__74655 = cljs.core.rest.call(null,remainder);
suffix = G__74654;
remainder = G__74655;
continue;
} else {
if(cljs.core.truth_(pred__74649.call(null,"..",expr__74650))){
var G__74656 = cljs.core.conj.call(null,suffix,"..");
var G__74657 = cljs.core.rest.call(null,remainder);
suffix = G__74656;
remainder = G__74657;
continue;
} else {
var G__74658 = cljs.core.conj.call(null,suffix,curr);
var G__74659 = cljs.core.rest.call(null,remainder);
suffix = G__74658;
remainder = G__74659;
continue;
}
...
var vec__74663 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__74663,(0),null);
var path = cljs.core.nth.call(null,vec__74663,(1),null);
var post_path = cljs.core.nth.call(null,vec__74663,(2),null);
...
var vec__74669 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__74669,(0),null);
var path = cljs.core.nth.call(null,vec__74669,(1),null);
var post_path = cljs.core.nth.call(null,vec__74669,(2),null);
