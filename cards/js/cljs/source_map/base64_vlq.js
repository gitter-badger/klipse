...
var digit_62078 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_62079__$1 = (vlq >>> cljs.source_map.base64_vlq.vlq_base_shift);
while(true){
if((vlq_62079__$1 > (0))){
var digit_62080__$1 = (digit_62078 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_62080__$1));

var G__62081 = (vlq_62079__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__62082 = (vlq_62079__$1 >>> cljs.source_map.base64_vlq.vlq_base_shift);
digit_62078 = G__62081;
vlq_62079__$1 = G__62082;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_62078));
}
break;
}
...
var G__62083 = i__$1;
var G__62084 = result__$1;
var G__62085 = shift__$1;
i = G__62083;
result = G__62084;
shift = G__62085;
continue;
