...
var G__60662 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__60662;
continue;
} else {
return ch;
...
var vec__60666 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__60666,(0),null);
return (match === s);
});
...
var len__7296__auto___60671 = arguments.length;
var i__7297__auto___60672 = (0);
while(true){
if((i__7297__auto___60672 < len__7296__auto___60671)){
args__7303__auto__.push((arguments[i__7297__auto___60672]));

var G__60673 = (i__7297__auto___60672 + (1));
i__7297__auto___60672 = G__60673;
continue;
} else {
}
break;
...
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq60669){
var G__60670 = cljs.core.first.call(null,seq60669);
var seq60669__$1 = cljs.core.next.call(null,seq60669);
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic(G__60670,seq60669__$1);
});

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__60674__delegate = function (rdr,_){
return cljs.tools.reader.reader_types.reader_error.call(null,rdr,msg);
};
var G__60674 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__60675__i = 0, G__60675__a = new Array(arguments.length -  1);
while (G__60675__i < G__60675__a.length) {G__60675__a[G__60675__i] = arguments[G__60675__i + 1]; ++G__60675__i;}
  _ = new cljs.core.IndexedSeq(G__60675__a,0);
} 
return G__60674__delegate.call(this,rdr,_);};
G__60674.cljs$lang$maxFixedArity = 1;
G__60674.cljs$lang$applyTo = (function (arglist__60676){
var rdr = cljs.core.first(arglist__60676);
var _ = cljs.core.rest(arglist__60676);
return G__60674__delegate(rdr,_);
});
G__60674.cljs$core$IFn$_invoke$arity$variadic = G__60674__delegate;
return G__60674;
})()
;
});
