...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__31390_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__31390_SHARP_),cljs.core.second(p1__31390_SHARP_));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__31391_SHARP_,p2__31392_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__31391_SHARP_,p2__31392_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__31420 = cljs.core.first(path_pieces);
switch (G__31420) {
case "":
...
var G__31433 = (((cljs.core.first(path_pieces) instanceof cljs.core.Keyword))?cljs.core.first(path_pieces).fqn:null);
switch (G__31433) {
case "root":
...
var G__31443 = cljs.core.last(path_pieces);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$cwd,G__31443)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path_pieces,"..");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("..",G__31443)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path_pieces,"..");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$root,G__31443)){
return path_pieces;
} else {
...
while(true){
var vec__31452 = remaining_path;
var seq__31453 = cljs.core.seq(vec__31452);
var first__31454 = cljs.core.first(seq__31453);
var seq__31453__$1 = cljs.core.next(seq__31453);
var curr = first__31454;
var remainder = seq__31453__$1;
var pred__31455 = cljs.core._EQ_;
var expr__31456 = curr;
if(cljs.core.truth_((pred__31455.cljs$core$IFn$_invoke$arity$2 ? pred__31455.cljs$core$IFn$_invoke$arity$2(null,expr__31456) : pred__31455.call(null,null,expr__31456)))){
return result;
} else {
if(cljs.core.truth_((pred__31455.cljs$core$IFn$_invoke$arity$2 ? pred__31455.cljs$core$IFn$_invoke$arity$2("",expr__31456) : pred__31455.call(null,"",expr__31456)))){
var G__31458 = result;
var G__31459 = remainder;
result = G__31458;
remaining_path = G__31459;
continue;
} else {
if(cljs.core.truth_((pred__31455.cljs$core$IFn$_invoke$arity$2 ? pred__31455.cljs$core$IFn$_invoke$arity$2(".",expr__31456) : pred__31455.call(null,".",expr__31456)))){
var G__31460 = result;
...
result = G__31460;
remaining_path = G__31461;
continue;
} else {
if(cljs.core.truth_((pred__31455.cljs$core$IFn$_invoke$arity$2 ? pred__31455.cljs$core$IFn$_invoke$arity$2("..",expr__31456) : pred__31455.call(null,"..",expr__31456)))){
var G__31462 = pathetic.core.up_dir(result);
var G__31463 = remainder;
result = G__31462;
remaining_path = G__31463;
continue;
} else {
var G__31464 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,curr);
var G__31465 = remainder;
result = G__31464;
remaining_path = G__31465;
continue;
}
}
}
...
var pred__31469 = cljs.core._EQ_;
var expr__31470 = curr;
if(cljs.core.truth_((pred__31469.cljs$core$IFn$_invoke$arity$2 ? pred__31469.cljs$core$IFn$_invoke$arity$2(null,expr__31470) : pred__31469.call(null,null,expr__31470)))){
return suffix;
} else {
if(cljs.core.truth_((pred__31469.cljs$core$IFn$_invoke$arity$2 ? pred__31469.cljs$core$IFn$_invoke$arity$2("",expr__31470) : pred__31469.call(null,"",expr__31470)))){
var G__31483 = suffix;
var G__31484 = cljs.core.rest(remainder);
suffix = G__31483;
remainder = G__31484;
continue;
} else {
if(cljs.core.truth_((pred__31469.cljs$core$IFn$_invoke$arity$2 ? pred__31469.cljs$core$IFn$_invoke$arity$2(".",expr__31470) : pred__31469.call(null,".",expr__31470)))){
var G__31485 = suffix;
var G__31486 = cljs.core.rest(remainder);
suffix = G__31485;
remainder = G__31486;
continue;
} else {
if(cljs.core.truth_((pred__31469.cljs$core$IFn$_invoke$arity$2 ? pred__31469.cljs$core$IFn$_invoke$arity$2("..",expr__31470) : pred__31469.call(null,"..",expr__31470)))){
var G__31487 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(suffix,"..");
var G__31488 = cljs.core.rest(remainder);
suffix = G__31487;
remainder = G__31488;
continue;
} else {
var G__31489 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(suffix,curr);
var G__31490 = cljs.core.rest(remainder);
suffix = G__31489;
remainder = G__31490;
continue;
}
...
var vec__31530 = pathetic.core.split_url_on_path(url_or_string);
var pre_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31530,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31530,(1),null);
var post_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31530,(2),null);
...
var vec__31547 = pathetic.core.split_url_on_path(url_or_string);
var pre_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31547,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31547,(1),null);
var post_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31547,(2),null);
