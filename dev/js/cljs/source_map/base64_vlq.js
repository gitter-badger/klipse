...
var digit_24112 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_24113__$1 = (vlq >>> cljs.source_map.base64_vlq.vlq_base_shift);
while(true){
if((vlq_24113__$1 > (0))){
var digit_24115__$1 = (digit_24112 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_24115__$1));

var G__24116 = (vlq_24113__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__24117 = (vlq_24113__$1 >>> cljs.source_map.base64_vlq.vlq_base_shift);
digit_24112 = G__24116;
vlq_24113__$1 = G__24117;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_24112));
}
break;
}
...
var G__24130 = i__$1;
var G__24131 = result__$1;
var G__24132 = shift__$1;
i = G__24130;
result = G__24131;
shift = G__24132;
continue;
