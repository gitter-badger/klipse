...
var map__32185 = klipse.utils.url_parameters();
var map__32185__$1 = ((((!((map__32185 == null)))?((((map__32185.cljs$lang$protocol_mask$partition0$ & (64))) || (map__32185.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__32185):map__32185);
var js_only = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32185__$1,cljs.core.cst$kw$js_only);
var eval_only = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32185__$1,cljs.core.cst$kw$eval_only);
...
klipse.control.control.app_state = (function (){var G__32189 = new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$input,null,cljs.core.cst$kw$compilation,null,cljs.core.cst$kw$evaluation_DASH_js,null,cljs.core.cst$kw$evaluation_DASH_clj,null,cljs.core.cst$kw$code_DASH_layout,klipse.control.control.init_layout()], null);
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__32189) : cljs.core.atom.call(null,G__32189));
})();
}
