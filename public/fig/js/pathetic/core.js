...
return cljs.core.map.call(null,cljs.core.first,cljs.core.take_while.call(null,(function (p1__41605_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__41605_SHARP_),cljs.core.second.call(null,p1__41605_SHARP_));
}),cljs.core.map.call(null,(function (p1__41606_SHARP_,p2__41607_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__41606_SHARP_,p2__41607_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__41609 = cljs.core.first.call(null,path_pieces);
switch (G__41609) {
case "":
...
var G__41612 = (((cljs.core.first.call(null,path_pieces) instanceof cljs.core.Keyword))?cljs.core.first.call(null,path_pieces).fqn:null);
switch (G__41612) {
case "root":
...
var G__41615 = cljs.core.last.call(null,path_pieces);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cwd","cwd",14056523),G__41615)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,"..",G__41615)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),G__41615)){
return path_pieces;
} else {
...
while(true){
var vec__41622 = remaining_path;
var seq__41623 = cljs.core.seq.call(null,vec__41622);
var first__41624 = cljs.core.first.call(null,seq__41623);
var seq__41623__$1 = cljs.core.next.call(null,seq__41623);
var curr = first__41624;
var remainder = seq__41623__$1;
var pred__41625 = cljs.core._EQ_;
var expr__41626 = curr;
if(cljs.core.truth_(pred__41625.call(null,null,expr__41626))){
return result;
} else {
if(cljs.core.truth_(pred__41625.call(null,"",expr__41626))){
var G__41628 = result;
var G__41629 = remainder;
result = G__41628;
remaining_path = G__41629;
continue;
} else {
if(cljs.core.truth_(pred__41625.call(null,".",expr__41626))){
var G__41630 = result;
var G__41631 = remainder;
result = G__41630;
remaining_path = G__41631;
continue;
} else {
if(cljs.core.truth_(pred__41625.call(null,"..",expr__41626))){
var G__41632 = pathetic.core.up_dir.call(null,result);
var G__41633 = remainder;
result = G__41632;
remaining_path = G__41633;
continue;
} else {
var G__41634 = cljs.core.conj.call(null,result,curr);
var G__41635 = remainder;
result = G__41634;
remaining_path = G__41635;
continue;
}
}
}
...
var pred__41639 = cljs.core._EQ_;
var expr__41640 = curr;
if(cljs.core.truth_(pred__41639.call(null,null,expr__41640))){
return suffix;
} else {
if(cljs.core.truth_(pred__41639.call(null,"",expr__41640))){
var G__41642 = suffix;
var G__41643 = cljs.core.rest.call(null,remainder);
suffix = G__41642;
remainder = G__41643;
continue;
} else {
if(cljs.core.truth_(pred__41639.call(null,".",expr__41640))){
var G__41644 = suffix;
var G__41645 = cljs.core.rest.call(null,remainder);
suffix = G__41644;
remainder = G__41645;
continue;
} else {
if(cljs.core.truth_(pred__41639.call(null,"..",expr__41640))){
var G__41646 = cljs.core.conj.call(null,suffix,"..");
var G__41647 = cljs.core.rest.call(null,remainder);
suffix = G__41646;
remainder = G__41647;
continue;
} else {
var G__41648 = cljs.core.conj.call(null,suffix,curr);
var G__41649 = cljs.core.rest.call(null,remainder);
suffix = G__41648;
remainder = G__41649;
continue;
}
...
var vec__41653 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__41653,(0),null);
var path = cljs.core.nth.call(null,vec__41653,(1),null);
var post_path = cljs.core.nth.call(null,vec__41653,(2),null);
...
var vec__41659 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__41659,(0),null);
var path = cljs.core.nth.call(null,vec__41659,(1),null);
var post_path = cljs.core.nth.call(null,vec__41659,(2),null);
...
//# sourceMappingURL=core.js.map?rel=1465451169272