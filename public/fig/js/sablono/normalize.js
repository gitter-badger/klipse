...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__36270_SHARP_){
return ((p1__36270_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__36270_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__36272,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__36272;
}
});
...
var len__23690__auto___36276 = arguments.length;
var i__23691__auto___36277 = (0);
while(true){
if((i__23691__auto___36277 < len__23690__auto___36276)){
args__23697__auto__.push((arguments[i__23691__auto___36277]));

var G__36278 = (i__23691__auto___36277 + (1));
i__23691__auto___36277 = G__36278;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__23698__auto__);
});
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,p1__36273_SHARP_);
});})(maps__$1))
...
var G__36275 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__36275,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__36275;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq36274){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq36274));
});
...
var vec__36284 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__36284,(0),null);
var names = cljs.core.nth.call(null,vec__36284,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__36284,tag_name,names){
return (function (p1__36279_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__36279_SHARP_));
});})(matches,vec__36284,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__36284,tag_name,names){
return (function (p1__36280_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__36280_SHARP_));
});})(matches,vec__36284,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__36287){
var vec__36294 = p__36287;
...
var tag = first__36296;
var content = seq__36295__$1;
...
var vec__36297 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__36297,(0),null);
var id = cljs.core.nth.call(null,vec__36297,(1),null);
var class$ = cljs.core.nth.call(null,vec__36297,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1465451163160