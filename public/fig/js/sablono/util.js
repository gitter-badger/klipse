...
var x__23278__auto__ = (((x == null))?null:x);
var m__23279__auto__ = (sablono.util.to_str[goog.typeOf(x__23278__auto__)]);
if(!((m__23279__auto__ == null))){
return m__23279__auto__.call(null,x);
} else {
var m__23279__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__23279__auto____$1 == null))){
return m__23279__auto____$1.call(null,x);
} else {
...
var x__23278__auto__ = (((x == null))?null:x);
var m__23279__auto__ = (sablono.util.to_uri[goog.typeOf(x__23278__auto__)]);
if(!((m__23279__auto__ == null))){
return m__23279__auto__.call(null,x);
} else {
var m__23279__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__23279__auto____$1 == null))){
return m__23279__auto____$1.call(null,x);
} else {
...
var len__23690__auto___36257 = arguments.length;
var i__23691__auto___36258 = (0);
while(true){
if((i__23691__auto___36258 < len__23690__auto___36257)){
args__23697__auto__.push((arguments[i__23691__auto___36258]));

var G__36259 = (i__23691__auto___36258 + (1));
i__23691__auto___36258 = G__36259;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__23698__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq36256){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq36256));
});
...
var vec__36263 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__36264 = cljs.core.seq.call(null,vec__36263);
var first__36265 = cljs.core.first.call(null,seq__36264);
var seq__36264__$1 = cljs.core.next.call(null,seq__36264);
var first_word = first__36265;
var words = seq__36264__$1;
...
var G__36267 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__36267,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__36267;
}
} else {
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__22615__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1465451163066