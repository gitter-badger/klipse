...
var x30740_30750 = klipse.cards.ui.layout.global.Root_computed.prototype;
x30740_30750.componentWillUpdate = ((function (x30740_30750){
...
var ident__25683__auto___30751 = om.next.ident.call(null,this__25679__auto__,om.next.props.call(null,this__25679__auto__));
var next_ident__25684__auto___30752 = om.next.ident.call(null,this__25679__auto__,om.next._next_props.call(null,next_props__25680__auto__,this__25679__auto__));
if(cljs.core.not_EQ_.call(null,ident__25683__auto___30751,next_ident__25684__auto___30752)){
var idxr__25685__auto___30753 = cljs.core.get_in.call(null,om.next.get_reconciler.call(null,this__25679__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"indexer","indexer",-1774914315)], null));
if((idxr__25685__auto___30753 == null)){
} else {
cljs.core.swap_BANG_.call(null,new cljs.core.Keyword(null,"indexes","indexes",1496475545).cljs$core$IFn$_invoke$arity$1(idxr__25685__auto___30753),((function (idxr__25685__auto___30753,ident__25683__auto___30751,next_ident__25684__auto___30752,this__25679__auto__,x30740_30750){
return (function (indexes__25686__auto__){
return cljs.core.update_in.call(null,cljs.core.update_in.call(null,indexes__25686__auto__,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),ident__25683__auto___30751], null),cljs.core.disj,this__25679__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),next_ident__25684__auto___30752], null),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentHashSet.EMPTY),this__25679__auto__);
});})(idxr__25685__auto___30753,ident__25683__auto___30751,next_ident__25684__auto___30752,this__25679__auto__,x30740_30750))
);
}
} else {
}
...
x30740_30750.shouldComponentUpdate = ((function (x30740_30750){
return (function (next_props__25680__auto__,next_state__25681__auto__){
var this__25679__auto__ = this;
...
var next_props__25680__auto____$2 = (function (){var G__30742 = next_props__25680__auto____$1;
if((next_props__25680__auto____$1 instanceof om.next.OmProps)){
return om.next.unwrap.call(null,G__30742);
} else {
return G__30742;
}
})();
...
x30740_30750.componentWillUnmount = ((function (x30740_30750){
return (function (){
var this__25679__auto__ = this;
...
x30740_30750.componentDidUpdate = ((function (x30740_30750){
...
x30740_30750.isMounted = ((function (x30740_30750){
return (function (){
var this__25679__auto__ = this;
...
x30740_30750.componentWillMount = ((function (x30740_30750){
return (function (){
var this__25679__auto__ = this;
...
x30740_30750.render = ((function (x30740_30750){
return (function (){
var this__25678__auto__ = this;
var this$ = this__25678__auto__;
var _STAR_reconciler_STAR_30743 = om.next._STAR_reconciler_STAR_;
var _STAR_depth_STAR_30744 = om.next._STAR_depth_STAR_;
var _STAR_shared_STAR_30745 = om.next._STAR_shared_STAR_;
var _STAR_instrument_STAR_30746 = om.next._STAR_instrument_STAR_;
var _STAR_parent_STAR_30747 = om.next._STAR_parent_STAR_;
...
}finally {om.next._STAR_parent_STAR_ = _STAR_parent_STAR_30747;

om.next._STAR_instrument_STAR_ = _STAR_instrument_STAR_30746;

om.next._STAR_shared_STAR_ = _STAR_shared_STAR_30745;

om.next._STAR_depth_STAR_ = _STAR_depth_STAR_30744;

om.next._STAR_reconciler_STAR_ = _STAR_reconciler_STAR_30743;
}});})(x30740_30750))
;
...
var x30748_30754 = klipse.cards.ui.layout.global.Root_computed;


var x30749_30755 = klipse.cards.ui.layout.global.Root_computed.prototype;
...
//# sourceMappingURL=global.js.map?rel=1465542670384