...
var args72042 = [];
var len__7296__auto___72046 = arguments.length;
var i__7297__auto___72047 = (0);
while(true){
if((i__7297__auto___72047 < len__7296__auto___72046)){
args72042.push((arguments[i__7297__auto___72047]));

var G__72048 = (i__7297__auto___72047 + (1));
i__7297__auto___72047 = G__72048;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args72042.length)].join('')));
...
var G__72045 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__72045,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__72045;
}
});
...
var len__7296__auto___72053 = arguments.length;
var i__7297__auto___72054 = (0);
while(true){
if((i__7297__auto___72054 < len__7296__auto___72053)){
args__7303__auto__.push((arguments[i__7297__auto___72054]));

var G__72055 = (i__7297__auto___72054 + (1));
i__7297__auto___72054 = G__72055;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq72050){
var G__72051 = cljs.core.first.call(null,seq72050);
var seq72050__$1 = cljs.core.next.call(null,seq72050);
var G__72052 = cljs.core.first.call(null,seq72050__$1);
var seq72050__$2 = cljs.core.next.call(null,seq72050__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__72051,G__72052,seq72050__$2);
});
...
var map__72059 = m;
var map__72059__$1 = ((((!((map__72059 == null)))?((((map__72059.cljs$lang$protocol_mask$partition0$ & (64))) || (map__72059.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__72059):map__72059);
var file = cljs.core.get.call(null,map__72059__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__72059__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__72059__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__72059,map__72059__$1,file,line,column){
return (function (p1__72056_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__72056_SHARP_));
});})(map__72059,map__72059__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__7146__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__7146__auto__,prefer_table__7147__auto__,method_cache__7148__auto__,cached_hierarchy__7149__auto__,hierarchy__7150__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__6221__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__6221__auto__)){
return or__6221__auto__;
} else {
...
var temp__4657__auto___72061 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___72061)){
var message_72062 = temp__4657__auto___72061;
cljs.core.println.call(null,message_72062);
} else {
}
...
var temp__4657__auto___72063 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___72063)){
var message_72064 = temp__4657__auto___72063;
cljs.core.println.call(null,message_72064);
} else {
}
...
var G__72074 = exception.stack;
var G__72074__$1 = (((G__72074 == null))?null:clojure.string.split_lines.call(null,G__72074));
var G__72074__$2 = (((G__72074__$1 == null))?null:cljs.core.get.call(null,G__72074__$1,depth));
if((G__72074__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__72074__$2);
}
} else {
...
var vec__72075 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__72075,(0),null);
var column = cljs.core.nth.call(null,vec__72075,(1),null);
var vec__72078 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__72078,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__72078,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__72078,(2),null);
...
var m__$1 = (function (){var G__72082 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__72082) {
case "fail":
...
var G__72088 = (function (){var G__72087 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__72087);
} else {
return G__72087;
}
})();
...
return cljs.core.vary_meta.call(null,G__72090,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e72093){var e = e72093;
var G__72094 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__72094) {
...
var vec__72099 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__72099,(0),null);
var types = vec__72099;
...
return cljs.core.map.call(null,(function (p__72111){
var vec__72112 = p__72111;
var ns = cljs.core.nth.call(null,vec__72112,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__72112,(1),null);
return ((function (vec__72112,ns,vars__$1){
return (function (){
...
var G__72115 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__72115) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__72115,env,once_fixtures,each_fixtures,vec__72112,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__72115,env,once_fixtures,each_fixtures,vec__72112,ns,vars__$1){
return (function (){
var seq__72116 = cljs.core.seq.call(null,vars__$1);
var chunk__72117 = null;
var count__72118 = (0);
var i__72119 = (0);
while(true){
if((i__72119 < count__72118)){
var v = cljs.core._nth.call(null,chunk__72117,i__72119);
var temp__4657__auto___72121 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___72121)){
var t_72122 = temp__4657__auto___72121;
each_fixture_fn.call(null,((function (seq__72116,chunk__72117,count__72118,i__72119,t_72122,temp__4657__auto___72121,v,each_fixture_fn,G__72115,env,once_fixtures,each_fixtures,vec__72112,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_72122)));
});})(seq__72116,chunk__72117,count__72118,i__72119,t_72122,temp__4657__auto___72121,v,each_fixture_fn,G__72115,env,once_fixtures,each_fixtures,vec__72112,ns,vars__$1))
);
} else {
}

var G__72123 = seq__72116;
var G__72124 = chunk__72117;
var G__72125 = count__72118;
var G__72126 = (i__72119 + (1));
seq__72116 = G__72123;
chunk__72117 = G__72124;
count__72118 = G__72125;
i__72119 = G__72126;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__72116);
if(temp__4657__auto__){
var seq__72116__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__72116__$1)){
var c__7032__auto__ = cljs.core.chunk_first.call(null,seq__72116__$1);
var G__72127 = cljs.core.chunk_rest.call(null,seq__72116__$1);
var G__72128 = c__7032__auto__;
var G__72129 = cljs.core.count.call(null,c__7032__auto__);
var G__72130 = (0);
seq__72116 = G__72127;
...
var v = cljs.core.first.call(null,seq__72116__$1);
var temp__4657__auto___72131__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___72131__$1)){
var t_72132 = temp__4657__auto___72131__$1;
each_fixture_fn.call(null,((function (seq__72116,chunk__72117,count__72118,i__72119,t_72132,temp__4657__auto___72131__$1,v,seq__72116__$1,temp__4657__auto__,each_fixture_fn,G__72115,env,once_fixtures,each_fixtures,vec__72112,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_72132)));
});})(seq__72116,chunk__72117,count__72118,i__72119,t_72132,temp__4657__auto___72131__$1,v,seq__72116__$1,temp__4657__auto__,each_fixture_fn,G__72115,env,once_fixtures,each_fixtures,vec__72112,ns,vars__$1))
);
} else {
}

var G__72133 = cljs.core.next.call(null,seq__72116__$1);
var G__72134 = null;
var G__72135 = (0);
var G__72136 = (0);
seq__72116 = G__72133;
chunk__72117 = G__72134;
count__72118 = G__72135;
i__72119 = G__72136;
continue;
}
} else {
...
});})(each_fixture_fn,G__72115,env,once_fixtures,each_fixtures,vec__72112,ns,vars__$1))
);
});})(each_fixture_fn,G__72115,env,once_fixtures,each_fixtures,vec__72112,ns,vars__$1))
], null);
