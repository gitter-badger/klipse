...
cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__6845__auto__,k60619,else__6846__auto__){
var self__ = this;
var this__6845__auto____$1 = this;
var G__60621 = (((k60619 instanceof cljs.core.Keyword))?k60619.fqn:null);
switch (G__60621) {
case "splicing?":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k60619,else__6846__auto__);
...
;
return cljs.core.pr_sequential_writer.call(null,writer__6858__auto__,pr_pair__6860__auto__,"#cljs.tools.reader.impl.utils.ReaderConditional{",", ","}",opts__6859__auto__,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),self__.splicing_QMARK_],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"form","form",-1624062471),self__.form],null))], null),self__.__extmap));
});

cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IIterable$ = true;

cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__60618){
var self__ = this;
var G__60618__$1 = this;
return (new cljs.core.RecordIter((0),G__60618__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),new cljs.core.Keyword(null,"form","form",-1624062471)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),null,new cljs.core.Keyword(null,"form","form",-1624062471),null], null), null),k__6853__auto__)){
...
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,self__.form,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__6853__auto__)),null));
}
});

cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__6850__auto__,k__6851__auto__,G__60618){
var self__ = this;
var this__6850__auto____$1 = this;
var pred__60622 = cljs.core.keyword_identical_QMARK_;
var expr__60623 = k__6851__auto__;
if(cljs.core.truth_(pred__60622.call(null,new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),expr__60623))){
return (new cljs.tools.reader.impl.utils.ReaderConditional(G__60618,self__.form,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__60622.call(null,new cljs.core.Keyword(null,"form","form",-1624062471),expr__60623))){
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,G__60618,self__.__meta,self__.__extmap,null));
} else {
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,self__.form,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__6851__auto__,G__60618),null));
}
}
});
...
cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__6842__auto__,G__60618){
var self__ = this;
var this__6842__auto____$1 = this;
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,self__.form,G__60618,self__.__extmap,self__.__hash));
});
...
return cljs.core._write.call(null,writer__6878__auto__,"cljs.tools.reader.impl.utils/ReaderConditional");
});
...
cljs.tools.reader.impl.utils.map__GT_ReaderConditional = (function cljs$tools$reader$impl$utils$map__GT_ReaderConditional(G__60620){
return (new cljs.tools.reader.impl.utils.ReaderConditional(new cljs.core.Keyword(null,"splicing?","splicing?",-428596366).cljs$core$IFn$_invoke$arity$1(G__60620),new cljs.core.Keyword(null,"form","form",-1624062471).cljs$core$IFn$_invoke$arity$1(G__60620),null,cljs.core.dissoc.call(null,G__60620,new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),new cljs.core.Keyword(null,"form","form",-1624062471)),null));
});
