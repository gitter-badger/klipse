...
om.tempid.TempId.cljs$lang$ctorPrWriter = (function (this__6827__auto__,writer__6828__auto__,opt__6829__auto__){
return cljs.core._write.call(null,writer__6828__auto__,"om.tempid/TempId");
});
...
var args73615 = [];
var len__7296__auto___73618 = arguments.length;
var i__7297__auto___73619 = (0);
while(true){
if((i__7297__auto___73619 < len__7296__auto___73618)){
args73615.push((arguments[i__7297__auto___73619]));

var G__73620 = (i__7297__auto___73619 + (1));
i__7297__auto___73619 = G__73620;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args73615.length)].join('')));
