...
var self__ = this;
var this$ = this;
var x_SINGLEQUOTE__73396 = cljs.core.vary_meta.call(null,x,cljs.core.assoc,new cljs.core.Keyword(null,"client-time","client-time",-1212214195),(new Date()));
if((self__.size <= self__.arr.length)){
var id_SINGLEQUOTE__73397 = self__.arr.shift();
cljs.core.swap_BANG_.call(null,self__.index,((function (id_SINGLEQUOTE__73397,x_SINGLEQUOTE__73396,this$){
return (function (p1__73395_SHARP_){
return cljs.core.assoc.call(null,cljs.core.dissoc.call(null,p1__73395_SHARP_,id_SINGLEQUOTE__73397),id,x_SINGLEQUOTE__73396);
});})(id_SINGLEQUOTE__73397,x_SINGLEQUOTE__73396,this$))
);
} else {
cljs.core.swap_BANG_.call(null,self__.index,cljs.core.assoc,id,x_SINGLEQUOTE__73396);
}
...
return cljs.core._write.call(null,writer__6828__auto__,"om.next.cache/Cache");
});
