...
var len__7296__auto___45770 = arguments.length;
var i__7297__auto___45771 = (0);
while(true){
if((i__7297__auto___45771 < len__7296__auto___45770)){
args__7303__auto__.push((arguments[i__7297__auto___45771]));

var G__45772 = (i__7297__auto___45771 + (1));
i__7297__auto___45771 = G__45772;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq45769){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45769));
});
...
var vec__45776 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);
...
var first_word = first__45778;
var words = seq__45777__$1;
...
var G__45780 = clojure.set.rename_keys(m,kmap);
if(cljs.core.map_QMARK_(cljs.core.cst$kw$style.cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__45780,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$style], null),sablono$util$camel_case_keys);
} else {
return G__45780;
}
} else {
