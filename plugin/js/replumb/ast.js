...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__55847){
...
var G__55853 = [cljs.core.str(sym)].join('');
var G__55854 = [cljs.core.str(ns)].join('');
return goog.string.caseInsensitiveContains(G__55853,G__55854);
});
/**
...
var args55862 = [];
var len__7296__auto___55869 = arguments.length;
var i__7297__auto___55870 = (0);
while(true){
if((i__7297__auto___55870 < len__7296__auto___55869)){
args55862.push((arguments[i__7297__auto___55870]));

var G__55871 = (i__7297__auto___55870 + (1));
i__7297__auto___55870 = G__55871;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args55862.length)].join('')));
...
var vec__55865 = (function (){var G__55868 = (((type instanceof cljs.core.Keyword))?type.fqn:null);
switch (G__55868) {
case "require":
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [replumb.ast.requires,((function (G__55868){
return (function (p1__55855_SHARP_){
return replumb.ast.require_of_ns_QMARK_(required_ns,cljs.core.second(p1__55855_SHARP_));
});})(G__55868))
,replumb.ast.dissoc_require], null);

break;
case "macro-require":
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [replumb.ast.macro_requires,((function (G__55868){
return (function (p1__55856_SHARP_){
return replumb.ast.require_of_ns_QMARK_(required_ns,cljs.core.second(p1__55856_SHARP_));
});})(G__55868))
,replumb.ast.dissoc_macro_require], null);

break;
case "symbol":
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [replumb.ast.symbols,((function (G__55868){
return (function (p1__55857_SHARP_){
return replumb.ast.symbol_of_ns_QMARK_(required_ns,cljs.core.second(p1__55857_SHARP_));
});})(G__55868))
,replumb.ast.dissoc_symbol], null);

break;
case "macro":
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [replumb.ast.macros,((function (G__55868){
return (function (p1__55858_SHARP_){
return replumb.ast.macro_of_ns_QMARK_(required_ns,cljs.core.second(p1__55858_SHARP_));
});})(G__55868))
,replumb.ast.dissoc_macro], null);

break;
case "import":
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [replumb.ast.imports,((function (G__55868){
return (function (p1__55859_SHARP_){
return replumb.ast.import_of_ns_QMARK_(required_ns,cljs.core.second(p1__55859_SHARP_));
});})(G__55868))
...
var get_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55865,(0),null);
var pred = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55865,(1),null);
var dissoc_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55865,(2),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (syms,required_syms,vec__55865,get_fn,pred,dissoc_fn){
return (function (p1__55860_SHARP_,p2__55861_SHARP_){
return (dissoc_fn.cljs$core$IFn$_invoke$arity$3 ? dissoc_fn.cljs$core$IFn$_invoke$arity$3(p1__55860_SHARP_,requirer_ns,p2__55861_SHARP_) : dissoc_fn.call(null,p1__55860_SHARP_,requirer_ns,p2__55861_SHARP_));
});})(syms,required_syms,vec__55865,get_fn,pred,dissoc_fn))
,state,required_syms);
});
