...
if(((cljs.core.set_QMARK_(class$__$1)) || (cljs.core.sequential_QMARK_(class$__$1))) && (cljs.core.every_QMARK_((function (p1__45783_SHARP_){
return ((p1__45783_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__45783_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__45785,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$class], null),sablono.normalize.class$);
} else {
return G__45785;
}
});
...
var len__7296__auto___45789 = arguments.length;
var i__7297__auto___45790 = (0);
while(true){
if((i__7297__auto___45790 < len__7296__auto___45789)){
args__7303__auto__.push((arguments[i__7297__auto___45790]));

var G__45791 = (i__7297__auto___45790 + (1));
i__7297__auto___45790 = G__45791;
continue;
} else {
}
break;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,p1__45786_SHARP_);
});})(maps__$1))
...
var G__45788 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45788,cljs.core.cst$kw$class,classes__$1);
} else {
return G__45788;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq45787){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45787));
});
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45797,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45797,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.normalize.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__45797,tag_name,names){
return (function (p1__45792_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__45792_SHARP_));
});})(matches,vec__45797,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.normalize.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__45797,tag_name,names){
return (function (p1__45793_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__45793_SHARP_));
});})(matches,vec__45797,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__45800){
var vec__45807 = p__45800;
var seq__45808 = cljs.core.seq(vec__45807);
var first__45809 = cljs.core.first(seq__45808);
var seq__45808__$1 = cljs.core.next(seq__45808);
var tag = first__45809;
var content = seq__45808__$1;
...
var vec__45810 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45810,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45810,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45810,(2),null);
